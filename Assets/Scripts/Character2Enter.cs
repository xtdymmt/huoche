// dnSpy decompiler from Assembly-CSharp.dll class: Character2Enter
using System;
using UnityEngine;

public class Character2Enter : MonoBehaviour
{
	private void Start()
	{
		...
		this.counter = 1;
		this.CurrentState = Character2Enter.PlayAnim.IdleAnim;
	}
	...
	private void LateUpdate()
	{
		...
		if (this.counter == 1)
		{
			this.CurrentState = Character2Enter.PlayAnim.WalkAnim;
		...
		if (this.counter == 4)
		{
			this.CurrentState = Character2Enter.PlayAnim.ChnagetoSitAnim;
		...
		if (this.counter == 5)
		{
			this.CurrentState = Character2Enter.PlayAnim.SitAnim;
	...
	private Character2Enter.PlayAnim CurrentState;
