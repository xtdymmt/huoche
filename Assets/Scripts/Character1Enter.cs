// dnSpy decompiler from Assembly-CSharp.dll class: Character1Enter
using System;
using UnityEngine;

public class Character1Enter : MonoBehaviour
{
	private void Start()
	{
		...
		this.counter = 1;
		this.CurrentState = Character1Enter.PlayAnim.IdleAnim;
	}
	...
	private void LateUpdate()
	{
		...
		if (this.counter == 1)
		{
			this.CurrentState = Character1Enter.PlayAnim.WalkAnim;
		...
		if (this.counter == 4)
		{
			this.CurrentState = Character1Enter.PlayAnim.ChnagetoSitAnim;
		...
		if (this.counter == 5)
		{
			this.CurrentState = Character1Enter.PlayAnim.SitAnim;
	...
	private Character1Enter.PlayAnim CurrentState;
