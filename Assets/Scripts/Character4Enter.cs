// dnSpy decompiler from Assembly-CSharp.dll class: Character4Enter
using System;
using UnityEngine;

public class Character4Enter : MonoBehaviour
{
	private void Start()
	{
		...
		this.counter = 1;
		this.CurrentState = Character4Enter.PlayAnim.IdleAnim;
	}
	...
	private void LateUpdate()
	{
		...
		if (this.counter == 1)
		{
			this.CurrentState = Character4Enter.PlayAnim.WalkAnim;
		...
		if (this.counter == 4)
		{
			this.CurrentState = Character4Enter.PlayAnim.ChnagetoSitAnim;
		...
		if (this.counter == 5)
		{
			this.CurrentState = Character4Enter.PlayAnim.SitAnim;
	...
	private Character4Enter.PlayAnim CurrentState;
